...
import (
	...
	"go-product-service/internal/infrastructure"
	"go-product-service/internal/infrastructure/config"
	"go-product-service/internal/route"
	"go-product-service/pkg/validator"
	"os"
	"os/signal"
	"runtime"
	"syscall"
